...
- developer-tools
- uml
summary: '自然言語の記述から高品質なSVGおよびPNGの技術図を自動生成するAIエージェント向けスキルです。

  多彩なスタイルやUML図に対応しており、インタラクティブなアニメーション付き図表も出力可能です。

  コーディングアシスタントと統合して、手動での図作成の手間を大幅に削減します。'
title: 'yizhiyanhua-ai/fireworks-tech-graph: Generate production-quality SVG+PNG technical diagrams from natural language. 7 styles, UML support, and AI/Agent workflow patterns.'
read: false
shelf_life: medium
published_at: ''
---
