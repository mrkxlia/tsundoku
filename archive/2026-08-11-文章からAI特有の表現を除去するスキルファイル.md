...
- ライティング
- github
summary: 'AI生成文章にありがちな予測可能なフレーズや構造を検出し除去するためのスキルファイル。

  ClaudeなどのLLMに組み込むことで、より人間らしく自然な文章へ改善できる。

  禁止表現リストや構造的パターン、評価用のスコアリングシステムが含まれている。'
title: 'hardikpandya/stop-slop: A skill file for removing AI tells from prose'
read: false
shelf_life: medium
published_at: ''
---
