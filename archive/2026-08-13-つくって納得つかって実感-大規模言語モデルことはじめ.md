---
title: つくって納得つかって実感 大規模言語モデルことはじめ
...
- rag
- 機械学習
summary: 'リクルートの新人研修で用いられた大規模言語モデル（LLM）の入門解説資料です。

  LLMの定義やTokenizer、Transformerなどの動作原理から学習・評価手法まで幅広く網羅しています。

  ハンズオンを交えて構造化出力や簡易RAGの構築など実践的な開発手法まで学べます。'
read: false
shelf_life: long
---
