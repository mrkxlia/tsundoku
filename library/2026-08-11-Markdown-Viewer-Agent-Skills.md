...
| --- | --- | --- | --- | --- |
| � Data Charts | [vega](https://github.com/markdown-viewer/skills/blob/main/vega/SKILL.md) | ` ```vega-lite ` / ` ```vega ` | Data-driven charts with Vega-Lite and Vega | Bar, line, scatter, heatmap, area charts, radar, word cloud |
| 📈 Infographic | [infographic](https://github.com/markdown-viewer/skills/blob/main/infographic/SKILL.md) | ` ```infographic ` | 70+ pre-designed templates with YAML syntax | KPI cards, timelines, roadmaps, SWOT, funnels, org trees |
| 🎨 Mind Map | [canvas](https://github.com/markdown-viewer/skills/blob/main/canvas/SKILL.md) | ` ```canvas ` | Spatial node-based diagrams with JSON Canvas format | Mind maps, knowledge graphs, concept maps, planning boards |
...
| --- | --- | --- | --- | --- |
| 🏛️ Layered Architecture | [architecture](https://github.com/markdown-viewer/skills/blob/main/architecture/SKILL.md) | 13 layouts × 12 styles | Color-coded layer diagrams with grid-based component layout | System layers, microservices, enterprise apps |
| 🃏 Info Cards | [infocard](https://github.com/markdown-viewer/skills/blob/main/infocard/SKILL.md) | 13 layouts × 14 styles | Editorial-style information cards with magazine-quality typography | Knowledge summaries, data highlights, event announcements |
...
| --- | --- | --- | --- |
| 📐 UML Diagrams | [uml](https://github.com/markdown-viewer/skills/blob/main/uml/SKILL.md) | 14 UML diagram types with 9500+ mxgraph stencil icons | Software modeling, design patterns, API flows |
| ☁️ Cloud Architecture | [cloud](https://github.com/markdown-viewer/skills/blob/main/cloud/SKILL.md) | AWS, Azure, GCP, Alibaba, IBM, OpenStack, Kubernetes icons | Cloud infrastructure, serverless, multi-cloud |
| 🌐 Network Topology | [network](https://github.com/markdown-viewer/skills/blob/main/network/SKILL.md) | Network diagrams with Cisco/Citrix/industry device icons | LAN/WAN, enterprise networks, data center |
| 🔒 Security Architecture | [security](https://github.com/markdown-viewer/skills/blob/main/security/SKILL.md) | IAM, encryption, firewall, threat detection, compliance icons | Threat models, zero-trust, compliance auditing |
| 🏢 ArchiMate | [archimate](https://github.com/markdown-viewer/skills/blob/main/archimate/SKILL.md) | Enterprise architecture with ArchiMate layered modeling | Business/application/technology layer modeling |
| 📋 BPMN | [bpmn](https://github.com/markdown-viewer/skills/blob/main/bpmn/SKILL.md) | Business process modeling, EIP, and Lean Mapping stencils | Workflow automation, EIP, value stream mapping |
| 📊 Data Analytics | [data-analytics](https://github.com/markdown-viewer/skills/blob/main/data-analytics/SKILL.md) | Data pipeline and analytics workflow diagrams | ETL/ELT pipelines, data warehouses, ML workflows |
| 📡 IoT | [iot](https://github.com/markdown-viewer/skills/blob/main/iot/SKILL.md) | IoT device, sensor, and edge computing diagrams | Smart home/factory, fleet management, digital twins |
| 🧠 Mind Map | [mindmap](https://github.com/markdown-viewer/skills/blob/main/mindmap/SKILL.md) | Native PlantUML mind map syntax with directional branches and rich text | Brainstorming trees, study outlines, decision maps |
