---
url: https://x.com/shupeiman/status/2087009749682520075?s=12&t=22GY_jUSQsg0NcuE2S9fmA
...
- aiツール
- has-media
summary: 'Claude Codeにリンクを渡してフロー図解スキルとして登録できるGitHubツールが紹介されています。

  開発状況やTODOを自動で図解化してくれるため、作業内容が整理され仕事が捗ると評判です。
...
![](https://pbs.twimg.com/media/HPaMBc4bkAAhFfU.jpg?name=orig)

## 画像の内容

![](../assets/2026-08-11-Claude-Codeで開発状況を図解化する神GitHubツール-1.jpg)
